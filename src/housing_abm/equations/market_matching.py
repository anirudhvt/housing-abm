...
def expected_gross_rental_yield(monthly_rent: float, price: float, avg_days_on_market: float) -> float:
...
def sample_bid_up_multiplier(rng: np.random.Generator, n_bids: int,
